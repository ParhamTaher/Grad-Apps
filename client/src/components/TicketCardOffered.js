...
class TicketCardOffered extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount() {
        if (this.props.applicantID) {
            ...
            axios
                .get('/applicants/' + this.props.applicantID)
                .then(function(response) {
                    console.log('applicant name: ' + response.data.applicant);
                    self.setState({
                        applicantName:
                            response.data.applicant.fname +
                            ' ' +
                            response.data.applicant.lname
                    });
                });
        }
    ...
    handleDeclinedOfferSubmit = () => {
        ...
        this.props.actions.rejectApplicant(
            this.props.TID,
            ...
            <Panel id={this.props.TID}>
                ...
                <Panel.Collapse>
                    <Panel.Body>
                        ...
                        <Button
                            bsStyle="primary"
                            onClick={this.handleAcceptedOfferSubmit}
                        >
                            Accepted Offer
                        </Button>
                        <br />
                        <Button
                            bsStyle="danger"
                            onClick={this.handleDeclinedOfferSubmit}
                        >
                            Declined Offer
                        </Button>
                    </Panel.Body>
